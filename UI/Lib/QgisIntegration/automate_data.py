...
def main_procedure(input_path, output_path_shapefiles, output_path_excel, layers_serialize_file):
  ...
  for int_layer in int_layers:
    ...
    # layer in standalone environment
    layer = grid
    ...
    is1 = import_layer(output_path_shapefiles +
                       "(1)is-" + int_layer, "is1_file")
    add_is_field(is1, "is-" + int_layer[0: len_name], 1)
    is0 = import_layer(output_path_shapefiles +
                       "(0)is-" + int_layer, "is0_file")
